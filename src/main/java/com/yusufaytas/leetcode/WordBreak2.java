...
public class WordBreak2 {
  ...
  private List<List<String>> findSentences(Dictionary dictionary, String s, int index,
      Map<String, List<List<String>>> subSentences) {
    if (s.length() == index) {
    ...
    for (Integer candidateIndex : candidates) {
      ...
      List<List<String>> allPossibleSentences = findSentences(dictionary, s, candidateIndex,
          subSentences);
